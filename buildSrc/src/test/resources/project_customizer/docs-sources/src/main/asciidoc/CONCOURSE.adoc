...
the `CUSTOM_SCRIPT_IDENTIFIER` environment variable. For more on this technique, see
<<../common/README.adoc#Override specific project type pipeline functions,Override specific project type pipeline functions>>.
